        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastModifiedInventoryDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockLevel = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Product_CurrentStock", "[CurrentStock] >= 0");
                    table.CheckConstraint("CK_Product_Price", "[Price] >= 0");
                    table.CheckConstraint("CK_Product_ReorderLevel", "[ReorderLevel] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeadTimeDays = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    ...
                    Notes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    LastPurchaseDate = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValueSql: "GETDATE()"),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ProductSupplier_LeadTimeDays", "[LeadTimeDays] >= 1");
                    table.CheckConstraint("CK_ProductSupplier_SupplierPrice", "[SupplierPrice] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_StockHistory_NewStock", "[NewStock] >= 0");
                    table.ForeignKey(
                        name: "FK_StockHistory_Product",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSupplier_LastPurchaseDate",
                table: "ProductSuppliers",
                column: "LastPurchaseDate");

            migrationBuilder.CreateIndex(
                name: "IX_ProductSupplier_Product_IsPreferred",
                table: "ProductSuppliers",
                columns: new[] { "ProductId", "IsPreferred" });

            migrationBuilder.CreateIndex(
                name: "IX_ProductSupplier_Supplier_IsPreferred",
                table: "ProductSuppliers",
                columns: new[] { "SupplierId", "IsPreferred" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockHistory_ReferenceNumber",
                table: "StockHistories",
                column: "ReferenceNumber");

            migrationBuilder.CreateIndex(
                name: "IX_StockHistory_Type",
                table: "StockHistories",
                column: "Type");
